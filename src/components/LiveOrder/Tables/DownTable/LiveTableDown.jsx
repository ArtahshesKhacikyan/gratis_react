...
import DownTableHead from "./DownTableHead";
import DownTableBody from "./DownTableBody";
...
class LiveTableDown extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      order: "asc",
