...
import UpTableHead from "./UpTableHead";
import UpTableBody from "./UpTableBody";
...
class LiveTableUp extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      order: "asc",
