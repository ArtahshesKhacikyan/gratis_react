...
import DeviceInfoDesktopLayout from "./Layout/DeviceInfoDesktop-layout";
              ...
              >
                {(data) => {
                  ...
                  return (
                    <Form>
                      <FormPanel
                        mobileLayout={DeviceInfoDesktopLayout}
                        tabletLayout={DeviceInfoDesktopLayout}
                        desktopLayout={DeviceInfoDesktopLayout}
                        storage={data.values}
                        fields={DeviceInfo}
                        errors={data.errors}
